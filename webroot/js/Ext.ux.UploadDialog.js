...
p.i18n = {
  ...
  add_btn_tip: 'Adicionar archvivo a la cola.',
  remove_btn_text: 'Eliminar',
  remove_btn_tip: 'Eliminar Archivo de la cola.',
  reset_btn_text: 'Resetear',
  reset_btn_tip: 'Resetear cola.',
  upload_btn_start_text: 'Subir',
  upload_btn_stop_text: 'Abortar',
  upload_btn_start_tip: 'Subir archivos al servidor.',
  upload_btn_stop_tip: 'Parar subida.',
  close_btn_text: 'Cerrar',
  close_btn_tip: 'Cerrar Ventana.',
  ...
  err_file_type_not_permitted: 'El archivo que selecciono no esta permitido.<br/>Por favor seleccione otro tipo de archivos: {1}',
  note_queued_to_upload: 'Cola a subir.',
  note_processing: 'Subiendo...',
  note_upload_failed: 'Server is unavailable or internal server error occured.',
  note_upload_success: 'Correcto.',
  note_upload_error: 'Error al Subir.',
